...
export const staticBlogPosts = [
  {
    ...
    featuredImage: {
      image: {
        url: "/image/static-blogs/battery-charges-and-defenses-explained-by-battery-defense-attorney-clearwater.webp",
      },
      altText: "Battery defense attorney graphic showing criminal law books, gavel, case file, and battery charge documents explaining battery charges and legal defenses in Clearwater.",
      title: "Battery Charges and Defenses Explained by a Battery Defense Attorney",
      description: "Professional legal services graphic illustrating battery charges, criminal defense strategies, and Florida battery laws. The image features criminal law books, a judge's gavel, case files, and legal documents, highlighting how an experienced battery defense attorney in Clearwater helps clients understand charges, protect their rights, and build a strong legal defense.",
      caption: "Learn how a Clearwater battery defense attorney explains battery charges, legal defenses, Florida criminal laws, and the steps to protect your rights after an arrest.",
    },
