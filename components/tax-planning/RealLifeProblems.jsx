      ...
      <SectionLayout>
        <div className=" flex flex-col gap-6 lg:gap-20 justify-center items-center">
          ...
          <div className=" grid grid-cols-1 md:grid-cols-2 gap-3 lg:hidden">
            ...
            {/* Card 1 */}
            <div className="p-5   rounded-lg bg-[#B8CED2] max-w-96 w-full flex items-center justify-center gap-5 ">
          ...
          <div className=" relative hidden lg:block">
            {/* Card 1 */}
            <div className="p-5   rounded-lg bg-[#B8CED2] max-w-96 w-full flex items-center justify-center gap-5 absolute z-10 top-[0%] right-[8%] -rotate-2">
              <div className="p-4 bg-white inline-block rounded-full shrink-0">
                <Image
                  src="/image/tax-planning-page/money-bag.png"
                  alt="money-bag"
            ...
            {/* Card 2 */}
            <div className="p-5 md:p-7 bg-[#DBF0E9] rounded-lg max-w-96 w-full flex items-center justify-center gap-5 absolute z-10 top-[24%] -left-[8%] rotate-[10deg]">
              <div className="p-4 bg-white inline-block rounded-full shrink-0">
                <Image
                  src="/image/tax-planning-page/yes.png"
                  alt="yes"
            ...
            {/* Card 3 */}
            <div className="p-5 md:p-7 bg-[#E5E2FD]  rounded-lg max-w-96 w-full flex items-center justify-center gap-5 absolute z-10 -left-[12%] bottom-[3%] -rotate-[8deg]">
              <div className="p-4 bg-white inline-block rounded-full shrink-0">
                <Image
                  src="/image/tax-planning-page/pig-money.png"
                  alt="money-bag"
            ...
            {/* Card 4 */}
            <div className="p-5 md:p-7 bg-[#FEE7C8]  rounded-lg max-w-96 w-full flex items-center justify-center gap-5 absolute z-10 -right-[13%] b top-1/2 -translate-y-[50%] -rotate-[1.7deg]">
              <div className="p-4 bg-white inline-block rounded-full shrink-0">
                <Image
                  src="/image/tax-planning-page/money.png"
                  alt="money"
            ...
            {/* Card 5 */}
            <div className="p-5 md:p-7 bg-[#FAE7E5]  rounded-lg max-w-96 w-full flex items-center justify-center gap-5 absolute z-10 -right-[8%] bottom-[3%] rotate-[10deg]">
              <div className="p-4 bg-white inline-block rounded-full shrink-0">
                <Image
                  src="/image/tax-planning-page/pig-money-2.png"
                  alt="money-bag"
