...
const InitialConsultation = () => {
  return (
    <div className="bg-[#0E758B]">
      <SectionLayout>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            <h4 className="text-3xl md:text-5xl font-semibold text-white mb-4 !leading-tight">
              Arrange a free initial consultation
            </h4>
            <p className="text-xl md:text-xl font-normal text-white mb-2">
              We are committed to helping all of our clients create, sustain,
              protect and grow wealth for them and their families.
            </p>
            <p className="text-xl md:text-xl font-normal text-white ">
              To ersure we are a good fit for your needs, please provide your
              details below and we
            </p>
            <div className="mt-5 lg:mt-8">
              <h4 className="text-3xl md:text-5xl font-semibold text-white mb-4">
            ...
            <div className="w-full mt-6 lg:mt-10">
              <form>
                ...
                <Link
                  href="/"
                  id="view-all-btn"
                  className="bg-white !text-[#0E758B]  hover:text-[#0E758B] text-base md:text-xl px-6 md:px-10 py-3  border !border-white font-bold hover:shadow-xl duration-300 focus:!border-none "
                >
                  Book A Free Initial Consultation Now
                </Link>
              </form>
