              ...
              {nav.title === "Services" ? (
                ...
                >
                  <div className="group">
                    ...
                    <div className="absolute hidden duration-300 group-hover:block bg-white shadow-lg rounded p-6 max-h-[400px] overflow-y-scroll">
                      <ul className="py-2 ">
            ...
            {nav.title === "Services" ? (
              ...
              >
                <div className="group">
                  ...
                  <div className="absolute hidden duration-300 group-hover:block bg-white shadow-lg rounded p-6 z-50 w-[300px] max-h-[400px] overflow-y-scroll">
                    <ul className="py-2 ">
                      {serviceData?.map((el, index) => (
                        <li key={index}>
                          <Link
