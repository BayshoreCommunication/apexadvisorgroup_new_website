      ...
      <SectionLayout>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {servicesProcessData.map((service, index) => (
            <div
              key={index}
              className="flex flex-col lg:flex-row justify-center lg:justify-start items-center gap-6  px-12 py-8 bg-[#EEF6F8] rounded-lg hover:shadow-md border duration-300"
            >
