    ...
    <div>
      <div className='mt-0 md:mt-[130px]'>
        <PageHeroSection
          ...
          subheading={'Careers at Apex Advisor Group Inc'}
          paragraphOne={
            'Below are our current openings. Review the details for a role and apply directly — we read every application.'
          }
          paragraphTwo={''}
          ...
          <MotionEffect effect={'fade-up'} duration={'1200'} delay={0}>
            <div className='text-center max-w-[560px] mx-auto py-10'>
              ...
              <p className='text-base text-[#1B2639]/70 mb-6'>
                ...
                glad to hear from people who want to grow with us. Send us a
                note and we’ll keep you in mind for what’s next.
              </p>
              <Link
                href='/contact'
                    ...
                    <ul className='space-y-2'>
                      {position.whatsInItForYou.map((item, idx) => (
                        <li
                          ...
                          className='flex gap-3 text-base text-[#1B2639]/80'
                        >
                          <span className='mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-[#D5AD45]' />
                          <span>{item}</span>
                        </li>
                      ))}
                    </ul>
